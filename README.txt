...
- Third-party redistribution is allowed only if all the following conditions are met:
    ...
    - The mod and project use a different name to avoid confusion with Project Babylon.
    - Credit and a link to the original Project Babylon are provided.
    - You grant the Project Babylon a non-exclusive, royalty-free, worldwide license to use, copy, modify, and
...
- Sell addons, mods, or other derivative works that use any Project Babylon assets, including but not limited to
  textures, animations, sounds, or models.