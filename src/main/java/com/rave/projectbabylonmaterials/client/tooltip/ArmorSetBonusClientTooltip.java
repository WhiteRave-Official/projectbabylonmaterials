...
public class ArmorSetBonusClientTooltip implements ClientTooltipComponent {
    ...
    private final ArmorSetBonusTooltipData data;

    public ArmorSetBonusClientTooltip(ArmorSetBonusTooltipData data) {
        this.data = data;
    }
