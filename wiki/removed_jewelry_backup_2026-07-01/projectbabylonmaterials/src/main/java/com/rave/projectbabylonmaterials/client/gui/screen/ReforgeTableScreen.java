...
public class ReforgeTableScreen extends AbstractContainerScreen<ReforgeTableMenu> {
    ...
    private static final int XP_TEXT_Y = 47;
    private static final int XP_ICON_X = 86;
    private static final int XP_ICON_Y = 43;
    ...
    public ReforgeTableScreen(ReforgeTableMenu menu, Inventory inventory, Component title) {
    ...
    protected void renderBg(GuiGraphics guiGraphics, float partialTick, int mouseX, int mouseY) {
        ...
        renderSlotPlaceholder(guiGraphics, 3, GEM_SLOT_ICON);
    ...
    public boolean mouseClicked(double mouseX, double mouseY, int button) {
        if (button == 0 && this.menu.canAttemptAction() && isHammerHovered(mouseX, mouseY)) {
